...
def yahoo_pipeline(
    ...
    **kwargs,
    ...
    base_dataset = ncad.datasets.yahoo(
        path=data_dir,
    ...
    base_dataset = TimeSeriesDataset(
        ncad.utils.take_n_cycle(scaler(base_dataset), len(base_dataset))
    )
    ...
    # Split dataset
    train_set, validation_set, test_set = ncad.ts.split_train_val_test(
        data=base_dataset,
    ...
    print(f"NCAD on Yahoo dataset finished successfully!")
